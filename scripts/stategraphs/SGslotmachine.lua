...
{   
	...
	State{
		...
		timeline =
		{
			TimeEvent(1*FRAMES, function(inst) inst.SoundEmitter:KillSound("slotspin") end),
			TimeEvent(2*FRAMES, function(inst) inst.SoundEmitter:PlaySound(inst.sounds[inst.prizevalue]) end),
		},
